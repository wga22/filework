# Converted to Python3 - https://github.com/mjseeley/Gmail-Attachment-Downloader
...
def generate_mail_messages(gmail_user_name, p_word, resume_file, sTerm):
	...
	#has:attachment after:2004/01/01 before:2005/01/01 
	typ, data = imap_session.search(None, '(X-GM-RAW "has:attachment '+sTerm+'")')
...
if __name__ == '__main__':
	...
	aYears=[2004,2005,2006,2007,2008, 2009,2010,2011,2012,2013,2014,2015,2016]ode
	for nYear in aYears:
		terms = "after:"+str(nYear)+"/01/01 before:"+str(nYear+1)+"/01/01"
		for msg in generate_mail_messages(user_name, password, resumeFile,terms):
